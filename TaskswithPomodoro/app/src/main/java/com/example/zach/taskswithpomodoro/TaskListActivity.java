    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(new Intent(getBaseContext(), NewTaskCreatorActivity.class), 3);
                Log.i("test", "works");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (data.hasExtra("title")) {
                Snackbar.make(getCurrentFocus(), data.getStringExtra("title")+" added", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
                TaskContent.addItem(new TaskContent.Task(data.getStringExtra("title"),data.getStringExtra("details")));
            }
            else{
                Snackbar.make(getCurrentFocus(), "potato", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
            }
        }
